...
# mixture of DPPC/DSPC, DIPC, and CHOL in the MARTINI coarse-grained model.
#It can be used as well for atomistic simulations
#
...
sel2 = 'resname %s and name P'%lipid2
sel3 = 'resname %s and name O2'%lipid3
...
#Mixing Entropy
    mix_entropy = -(X_SL * np.log(X_SL)) +( X_DL * np.log(X_DL))
